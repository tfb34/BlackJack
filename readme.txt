...
-Instructions-
Download all the files by clicking on 'Download Zip' provided under 'clone or download' on github. 
In the terminal window,
compile->  'javac *.java'
run-> java BlackJack

*Make sure to change the path in terminal to the location of the folder where the files are downloaded. 
